...
class App
{
    ...
    private function register_core_providers(): void
    {
        $core_providers = [
            ...
            'person' => 'BuiltNorth\\WPSchema\\Providers\\PersonProvider',
            'offer' => 'BuiltNorth\\WPSchema\\Providers\\OfferProvider',
            'service' => 'BuiltNorth\\WPSchema\\Providers\\ServiceProvider',
